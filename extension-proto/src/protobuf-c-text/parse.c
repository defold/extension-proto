/* Generated by re2c 3.1 on Sat May 25 08:45:00 2024 */
#line 1 "protobuf-c-text/parse.re"
...
#line 409 "protobuf-c-text/parse.c"
{
	unsigned char yych;
	if ((scanner->limit - scanner->cursor) < 6) YYFILL(6);
	yych = *scanner->cursor;
	if (yych <= ':') {
		if (yych <= '!') {
			if (yych <= '\t') {
...
yy2:
	++scanner->cursor;
#line 455 "protobuf-c-text/parse.re"
	{ RETURN(TOK_EOF); }
#line 461 "protobuf-c-text/parse.c"
yy3:
	++scanner->cursor;
#line 453 "protobuf-c-text/parse.re"
	{ goto token_start; }
#line 466 "protobuf-c-text/parse.c"
yy4:
	++scanner->cursor;
#line 454 "protobuf-c-text/parse.re"
	{ scanner->line++; goto token_start; }
#line 471 "protobuf-c-text/parse.c"
yy5:
	++scanner->cursor;
	if (scanner->limit <= scanner->cursor) YYFILL(1);
	yych = *scanner->cursor;
	if (yych == '"') goto yy18;
	if (yych == '\\') goto yy19;
	goto yy5;
...
yy8:
	...
	if ((scanner->limit - scanner->cursor) < 2) YYFILL(2);
	yych = *scanner->cursor;
	if (yych <= '@') {
		if (yych <= '.') {
			if (yych >= '.') goto yy7;
...
yy9:
#line 419 "protobuf-c-text/parse.re"
	{
...
#line 522 "protobuf-c-text/parse.c"
yy10:
	++scanner->cursor;
#line 452 "protobuf-c-text/parse.re"
	{ RETURN(TOK_COLON); }
#line 527 "protobuf-c-text/parse.c"
yy11:
	++scanner->cursor;
	if (scanner->limit <= scanner->cursor) YYFILL(1);
	yych = *scanner->cursor;
...
yy13:
#line 431 "protobuf-c-text/parse.re"
	{
...
#line 557 "protobuf-c-text/parse.c"
yy14:
	yych = *++scanner->cursor;
	if (yych == 'a') goto yy22;
	goto yy12;
...
yy16:
	++scanner->cursor;
#line 450 "protobuf-c-text/parse.re"
	{ RETURN(TOK_OBRACE); }
#line 570 "protobuf-c-text/parse.c"
yy17:
	++scanner->cursor;
#line 451 "protobuf-c-text/parse.re"
	{ RETURN(TOK_CBRACE); }
#line 575 "protobuf-c-text/parse.c"
yy18:
	++scanner->cursor;
#line 441 "protobuf-c-text/parse.re"
	{
...
#line 588 "protobuf-c-text/parse.c"
yy19:
	++scanner->cursor;
	if (scanner->limit <= scanner->cursor) YYFILL(1);
	yych = *scanner->cursor;
...
yy28:
#line 429 "protobuf-c-text/parse.re"
	{ t.boolean=true; RETURN(TOK_BOOLEAN); }
#line 647 "protobuf-c-text/parse.c"
yy29:
	yych = *++scanner->cursor;
	if (yych <= 'Z') {
		if (yych <= '/') goto yy30;
...
yy30:
#line 430 "protobuf-c-text/parse.re"
	{ t.boolean=false; RETURN(TOK_BOOLEAN); }
#line 665 "protobuf-c-text/parse.c"
}
#line 456 "protobuf-c-text/parse.re"
